      ...
      <div className="relative w-full max-w-[380px] rounded-card bg-white p-9 pb-9 pt-11 shadow-[0_20px_50px_rgba(46,51,57,0.12)]">
        ...
        <form action={formAction} className="flex flex-col gap-[18px]">
          ...
          <button
            type="submit"
            disabled={pending}
            className="mt-1.5 rounded-full bg-orange py-[13px] text-[15px] font-bold text-white transition-colors hover:bg-orange-dark active:translate-y-px disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-dark"
          >
