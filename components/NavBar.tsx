        ...
        <div className="mx-auto flex max-w-[1280px] items-center gap-6 px-6 py-3.5">
          ...
          <div className="relative max-w-[520px] flex-1">
            ...
            <input
              ...
              className="w-full rounded-full border border-line bg-background py-2.5 pl-10 pr-4 text-sm text-ink placeholder:text-slate-light"
            />
          </div>

          <div className="ml-auto flex items-center gap-2.5">
            <button className="flex items-center gap-1.5 rounded-full bg-orange px-4 py-2.5 text-[13.5px] font-bold text-white shadow-[0_2px_8px_rgba(245,130,32,.35)] hover:bg-orange-dark">
